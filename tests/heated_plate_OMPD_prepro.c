# 0 "heated_plate_OMPD.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "heated_plate_OMPD.c"
...
extern void omp_free (void *,
        omp_allocator_handle_t )
  __attribute__((__nothrow__));
# 7 "heated_plate_OMPD.c" 2



# 9 "heated_plate_OMPD.c"
int main ( int argc, char *argv[] )
# 110 "heated_plate_OMPD.c"
{
...
# 215 "heated_plate_OMPD.c" 3 4
                         ((void *)0)
# 215 "heated_plate_OMPD.c"
                             );
# 237 "heated_plate_OMPD.c"
#pragma omp distribute allreduction(max:diff)
# 263 "heated_plate_OMPD.c"
  gettimeofday(&tv_end, 
# 263 "heated_plate_OMPD.c" 3 4
                       ((void *)0)
# 263 "heated_plate_OMPD.c"
                           );
